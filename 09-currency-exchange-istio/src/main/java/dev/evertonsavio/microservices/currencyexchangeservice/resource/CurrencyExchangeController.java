package dev.evertonsavio.microservices.currencyexchangeservice.resource;

import java.util.Map;

import dev.evertonsavio.microservices.currencyexchangeservice.util.environment.InstanceInformationService;
